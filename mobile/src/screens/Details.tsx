...
export function Details() {
  ...
  async function getDataPoolDetails() {
    try {
      ...
      console.log('🚀 ~ file: Details.tsx ~ line 16 ~ getDataPoolDetails ~ detailsResponse', detailsResponse.data.pool)
  ...
  return (
    <VStack flex={1} bgColor='gray.900'>
      <Header title={details.title} showBackButton showShareButton />
      {
        ...
        >
          <Option onPress={() => setOptionSelected('Seus palpites')} title='Seus palpites' isSelected={optionSelected === 'Seus palpites' ? true : false} />
          <Option onPress={() => setOptionSelected('Ranking do grupo')}title='Ranking do grupo' isSelected={optionSelected === 'Ranking do grupo' ? true : false} />
